...
// Ensure required classes/interfaces are loaded (especially if this file is included early)
require_once DATA_MACHINE_PATH . 'module-config/HandlerFactoryInterface.php';
...
class Dependency_Injection_Handler_Factory implements Data_Machine_Handler_Factory {
    ...
    /**
     * Create an input handler instance by slug.
     *
     * @param string $handler_slug
     * @return object|WP_Error
     */
    public function create_input_handler(string $handler_slug) {
        return $this->create_handler('input', $handler_slug);
    }

    /**
     * Create an output handler instance by slug.
     *
     * @param string $handler_slug
     * @return object|WP_Error
     */
    public function create_output_handler(string $handler_slug) {
        return $this->create_handler('output', $handler_slug);
    }
} 