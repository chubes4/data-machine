...
1. **Priority 10 - Plugin Core Directive**: Foundational AI agent identity and operational principles
2. **Priority 20 - Global System Prompt**: User-configured foundational AI behavior
3. **Priority 30 - Pipeline System Prompt**: Pipeline instructions and workflow visualization
4. **Priority 40 - Tool Definitions**: Dynamic tool prompts and workflow context
5. **Priority 50 - WordPress Site Context**: WordPress environment info (toggleable)
...
**Tool Categories**:
- **Handler Tools**: Step-specific tools (twitter_publish, wordpress_update) available when next step matches handler type
- **General Tools**: Universal tools (Google Search, Local Search, WebFetch, WordPress Post Reader) available to all AI agents
