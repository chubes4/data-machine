...
class Data_Machine_Input_Public_Rest_Api implements Data_Machine_Input_Handler_Interface {
	...
	public function get_input_data(object $module, array $source_config, int $user_id): array {
		...
		if (empty($module_id) || empty($user_id)) {
			...
			throw new Exception(__('Missing module ID or user ID provided to Public REST handler.', 'data-machine'));
		}
		if (!$this->db_processed_items || !$this->db_modules || !$this->db_projects) {
			...
			throw new Exception(__('Required database service not available in Public REST handler.', 'data-machine'));
		}
