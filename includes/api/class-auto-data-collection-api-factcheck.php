 ...
 */
class Auto_Data_Collection_API_FactCheck {
     ...
     * @param    string    $json_data        JSON data to fact-check.
     ...
     */
    public function fact_check_json( $api_key, $json_data, $fact_check_prompt ) {
        ...
        $args = array(
            ...
            'body' => wp_json_encode( array(
                'model'              => $model,
                'messages'           => $messages,
                'web_search_options' => array( 'search_context_size' => 'medium' ),
            ) ),
            'method'  => 'POST',
            'timeout' => 60,
        );
