 ...
 * - No inheritance requirements (extends BasePipelineStep for convenience only)
 ...
 * - execute(int $job_id): bool method (alternative names: run, process)
 ...
 */
class AIStep extends BasePipelineStep {
