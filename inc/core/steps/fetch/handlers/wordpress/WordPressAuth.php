<?php
/**
 * Handles WordPress API key authentication.
 *
 * @package    Data_Machine
 * @subpackage Data_Machine/core/handlers/input/wordpress
 * @since      1.0.0
 */
...
class WordPressAuth {
    ...
    public function store_credentials(string $api_url, string $username, string $api_key): bool {
        ...
        return apply_filters('dm_oauth', false, 'store', 'wordpress_fetch', $credentials);
    }
    ...
    public function get_credentials(): ?array {
        $credentials = apply_filters('dm_oauth', null, 'get', 'wordpress_fetch');
    ...
    public function remove_credentials(): bool {
        return apply_filters('dm_oauth', false, 'delete', 'wordpress_fetch');
    }
