...
function dm_register_utility_filters() {
    ...
    add_filter('dm_get_page_assets', function($assets, $page_slug) {
        ...
        $core_assets = [
            'pipelines' => [
                'css' => [
                    ...
                    'dm-admin-projects' => [
                        'file' => 'assets/css/admin-projects.css',
                        'deps' => ['dm-admin-core'],
                        'media' => 'all'
                    ]
                ],
                'js' => [
                    'dm-project-management' => [
                        'file' => 'assets/js/admin/core/data-machine-project-management.js',
                        'deps' => ['jquery'],
                        'in_footer' => true,
                        'localize' => [
                            'object' => 'dm_project_params',
                            'data' => [
                    ...
                    'dm-project-editing' => [
                        'file' => 'assets/js/admin/core/data-machine-project-editing.js',
                        'deps' => ['jquery'],
                        'in_footer' => true
                    ],
                    'dm-pipeline-builder' => [
                        'file' => 'assets/js/admin/pipelines/project-pipeline-builder.js',
        ...
        return $core_assets[$page_slug] ?? null;
    }, 10, 2);
