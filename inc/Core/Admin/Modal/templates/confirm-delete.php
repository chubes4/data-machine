    ...
    <div class="datamachine-warning-content">
                ...
                <ul class="datamachine-flows-list">
                    <?php foreach ($affected_flows as $flow): ?>
                        <li class="datamachine-flow-item">
                            <span class="datamachine-flow-name"><?php echo esc_html($flow['name'] ?? __('Unnamed Flow', 'data-machine')); ?></span>
        ...
        <?php else: ?>
            <div class="datamachine-no-flows">
                <?php if ($delete_type === 'pipeline'): ?>
                    <p class="datamachine-info"><?php esc_html_e('No flows are associated with this pipeline.', 'data-machine'); ?></p>
                <?php elseif ($delete_type === 'flow'): ?>
                    <!-- Flows don't have dependencies, so no message needed -->
                <?php else: ?>
                    <p class="datamachine-info"><?php esc_html_e('No flows are currently using this step.', 'data-machine'); ?></p>
                <?php endif; ?>
            </div>
        <?php endif; ?>
