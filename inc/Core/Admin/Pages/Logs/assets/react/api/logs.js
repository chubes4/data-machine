 ...
 * @returns {Promise<Object>} Agent types with labels and descriptions
 */
 ...
 * @returns {Promise<Object>} Log metadata including file info and configuration
 */
export const fetchLogMetadata = ( agentType ) => client.get( '/logs', { agent_type: agentType } );
