...
import { Icon, chevronDown, chevronRight, check, close } from '@wordpress/icons';
	...
	return (
		<div className="datamachine-tool-message">
			...
			>
				...
				/>
				<span
					className={`datamachine-tool-message__indicator datamachine-tool-message__indicator--${allSuccess ? 'success' : 'error'}`}
				>
