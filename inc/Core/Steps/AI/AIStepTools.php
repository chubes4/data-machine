...
class AIStepTools {
    ...
    /**
     * @return array Available general tools (no handler property)
     */
     ...
     * @return array Enabled tools for pipeline step
     */
    ...
    /**
     * @param string $pipeline_step_id Pipeline step UUID
     * @return array Tools data for template rendering
     */
     ...
     * @param string|null $current_pipeline_step_id Current AI step pipeline step ID
     * @return array Available tools filtered by configuration and enablement
     */
     ...
     * @param string|null $pipeline_step_id Pipeline step ID for filtering
     ...
     * @return bool Whether general tool is enabled globally
     */
