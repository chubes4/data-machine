...
class OAuth1Handler {
    ...
    public function get_request_token(
        ...
        try {
            ...
            // Get request token
            $request_token = $connection->oauth($request_token_url, ['oauth_callback' => $callback_url]);
    ...
    public function handle_callback(
        ...
        try {
            ...
            // Exchange tokens
            $access_token_data = $connection->oauth($access_token_url, ['oauth_verifier' => $oauth_verifier]);
