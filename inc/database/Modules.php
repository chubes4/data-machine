...
class Modules {
    ...
    public static function create_table() {
        ...
        $sql = "CREATE TABLE $table_name (
            ...
            flow_config longtext DEFAULT NULL,
    ...
    public function create_module( $project_id, $module_data ) {
        ...
        $data = array(
            ...
            'flow_config' => isset( $module_data['flow_config'] ) ? wp_json_encode( $module_data['flow_config'] ) : null, // Store flow config as JSON
    ...
    public function update_module( $module_id, $module_data, $user_id ) {
        ...
        $fields_to_update = [
            ...
            'flow_config'              => '%s', // Expects JSON encoded string
        ...
        foreach ( $fields_to_update as $field => $fmt ) {
            if ( isset( $module_data[ $field ] ) ) {
                ...
                if ( in_array( $field, [ 'data_source_config', 'output_config', 'flow_config' ] ) ) {
    ...
    public function update_module_schedule($module_id, $interval, $status, $user_id) {
        ...
        $allowed_intervals = Constants::get_allowed_module_intervals_for_validation();
