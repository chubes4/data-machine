        ...
        if ( isset($_POST['bluesky_app_password']) ) {
            try {
                ...
                if ($encrypted_password === false) {
                    ...
                    $logger?->error('Failed to encrypt Bluesky app password. It was not saved.');
                } else {
                    update_option('bluesky_app_password', $encrypted_password);
                    $updated = true;
                }
                ...
                // Error logging removed for production
                $logger = apply_filters('dm_get_logger', null);
                $logger?->error('An error occurred while encrypting the Bluesky app password. It was not saved.');
            }
        }
