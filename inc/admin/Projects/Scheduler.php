...
class Scheduler {
    ...
    public function schedule_project(int $project_id, string $interval, string $status) {
        ...
        as_unschedule_all_actions( $hook, $args, \DataMachine\Core\Constants::ACTION_GROUP );
        ...
        if ($status === 'active' && in_array($interval, $allowed_intervals)) {
            ...
            if ($interval_seconds !== null) {
                as_schedule_recurring_action( time(), $interval_seconds, $hook, $args, \DataMachine\Core\Constants::ACTION_GROUP );
            }
        }
    }
    ...
    public function unschedule_project(int $project_id) {
        as_unschedule_all_actions( 'dm_run_project_schedule_callback', ['project_id' => $project_id], \DataMachine\Core\Constants::ACTION_GROUP );
    }
    ...
    public function unschedule_module(int $module_id) {
        as_unschedule_all_actions( 'dm_run_module_schedule_callback', ['module_id' => $module_id], \DataMachine\Core\Constants::ACTION_GROUP );
    }
