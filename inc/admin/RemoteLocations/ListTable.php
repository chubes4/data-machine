...
class ListTable extends \WP_List_Table {
    ...
    public function prepare_items() {
        ...
        $this->items = $db_locations ? $db_locations->get_locations_for_user($user_id) : [];
     ...
     * Currently disabled but can be implemented when bulk operations are needed.
     *
     * @return array Empty array - no bulk actions currently supported.
     * @since 0.16.0
     */
    public function get_bulk_actions(): array {
        // Return empty array to disable bulk actions
        // Can be extended later for operations like bulk delete, bulk export, etc.
        return [];
    }

    /**
     * Process bulk actions.
     * Reserved for future implementation when bulk operations are needed.
     *
     * @since 0.16.0
     */
    public function process_bulk_action(): void {
        // No bulk actions currently implemented
        // Future bulk operations can be added here when needed
    }
