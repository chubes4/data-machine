...
class Data_Machine_OAuth_Threads {
    ...
    public function __construct(string $client_id, string $client_secret, ?Data_Machine_Logger $logger = null) {
        ...
        $this->logger = $logger;
        $this->encryption = new Data_Machine_Encryption_Helper(); // Ensure encryption helper is initialized
    ...
    public function handle_callback(int $user_id, string $code, string $state): bool|WP_Error {
        ...
        $account_details['access_token'] = Data_Machine_Encryption_Helper::encrypt($account_details['access_token']);
    ...
    public static function get_access_token(int $user_id): ?string {
        ...
        if ($needs_refresh) {
            ...
            if (!is_wp_error($refreshed_data)) {
                ...
                $account['access_token'] = Data_Machine_Encryption_Helper::encrypt($refreshed_data['access_token']);
