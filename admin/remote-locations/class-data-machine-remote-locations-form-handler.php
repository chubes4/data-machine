...
class Data_Machine_Remote_Locations_Form_Handler {
    ...
    /** @var ?Data_Machine_Sync_Remote_Locations */
     ...
     * @param Data_Machine_Sync_Remote_Locations|null $sync_service Sync service for remote locations.
     */
    public function __construct(
        Data_Machine_Database_Remote_Locations $db_locations,
        ?Data_Machine_Logger $logger = null,
        ?Data_Machine_Sync_Remote_Locations $sync_service = null
    ) {
    ...
    public function display_page() {
        ...
        if (empty($template_to_load) || $action === 'list') { 
            ...
            if (!class_exists('Remote_Locations_List_Table')) {
                require_once __DIR__ . '/class-remote-locations-list-table.php';
            }
