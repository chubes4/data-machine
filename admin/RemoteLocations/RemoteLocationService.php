...
class RemoteLocationService {
     ...
     *
     * @param DatabaseRemoteLocations $db_locations Instance of the remote locations database handler.
     * @since 0.16.0
     */
    public function __construct(DatabaseRemoteLocations $db_locations) {
