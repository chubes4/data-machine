 ...
 */
class Data_Machine_File_Upload_Handler {
     ...
     *
     * @since    NEXT_VERSION
     * @param    Data_Machine_Database_Modules  $db_modules   Database modules instance.
     * @param    Data_Machine_Database_Projects $db_projects  Database projects instance.  
